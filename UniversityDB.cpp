...
//  this->lastFive = new GenStack<UniversityDB>(5);
...
void UniversityDB::run() {
  GenStack<UniversityDB>* lastFive = new GenStack<UniversityDB>(5);
   lastFive->push(UniversityDB(*this));
